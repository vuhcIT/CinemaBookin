...
$IDPhim = $_POST['IDPhim1'];
$TenPhim = $_POST['TenPhim1'];
$PhongChieu = $_POST['PhongChieu1'];
$ThoiGian = $_POST['ThoiGian1'];
$NgayChieu = $_POST['NgayChieu1'];
$IDBuoiChieu = $_POST['IDBuoiChieu1'];
$SoGhe= $_POST['SoGhe1'];
$GiaVe= $_POST['GiaVe1'];
$ThoiGianBook= $_POST['ThoiGianBook1'];
$bookingID= $_POST['bookingID1'];
...
) AS ThoiGian, booking.phongchieuID, booking.SoGhe, booking.ThoiGianBook, bookingID, Khachhang.TenKH, phim.IDPhim, buoichieu.IDBuoiChieu, booking.bookingID,
CASE WHEN TrangThaiVe = 0 THEN 'Còn hiệu lực'
                    ELSE 'Hết hiệu lực'
               END AS TinhTrangVe
FROM phim 
...
where userID=".$IDKhachHang." and movieID=".$IDPhim." and phongchieuID=".$PhongChieu." and IDBuoiChieu=".$IDBuoiChieu." and bookingID=".$bookingID." and buoichieu.BuoiChieu>NOW()";
...
<!-- style="background-color:grey;" -->
    ...
    <div class="admin-section-header">
        ...
        <div><h5><a href ="../../testdangky/doimatkhau.php" class="special-link">Đổi Mật Khẩu</a></h5></div>
        </div>
        <div style="background-color: #333;" class="admin-login-info">
    ...
    <div class="admin-container">
        ...
        <div style="background-color: #333;" class="admin-section admin-section2" ng-app="crudUserBookingsApp" ng-controller="crudUserBookingsController" ng-init="user_profile='<?php echo $user['email']; ?>'">
            <div class="admin-section-column-table">
                ...
                $result = $conn->query($sql);
					if ($result->num_rows == 0){
						echo "<tr><td colspan = 9>Không có vé</td></tr>";
					} else {
				...
				?>
					<tr>
                        ...
                        <td><span style="color: #008000;">Đã Thanh Toán</span></td>
                        <td>
                        <span style="color: <?php echo ($row['TinhTrangVe'] == 'Còn hiệu lực' ? 'green' : 'red'); ?>"><?php echo $row['TinhTrangVe']; ?></span>
                        </td>
				...
				?>
                    ...
                    </div> <div class="thank-you">❤️ THANKS FOR YOUR TICKET RESERVATION ❤️ <br> 
                    ❤️ CẢM ƠN BẠN ĐÃ ĐẶT VÉ ❤️ <br> Please show this at the ticket bar <br> Hãy đưa thông tin vé này cho quầy bán vé</div>
                </div>
