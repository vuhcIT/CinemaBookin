<?php
	session_start();
	include("../detail/connect.php");
	
	if(isset($_GET["s"]) && !empty($_GET["s"])) {
		$key=$_GET["s"];
		$sql="select * from phim where TenPhim like '%$key%'";
	}
	else{
		$_SESSION['error_message'] = "Vui lòng nhập từ khóa !!!";
	...
	if ($result1->num_rows > 0) {
		...
		$_SESSION['error_message'] = "Không tìm thấy !!!";
		header('Location: ../../index.php');
		exit;
	}
	?>
...
<head>
	...
	<title>Movie Details Movie Booking WordPress Theme</title>
	...
	<link rel='stylesheet' id='fancybox-css' href='../../wp-content/plugins/movie-booking/assets/libs/fancybox/fancybox.css?ver=6.4.1' type='text/css' media='all'>
	...
	<link rel="alternate" type="application/json" href="../../wp-json/wp/v2/movie/1015">
	<link rel="EditURI" type="application/rsd+xml" title="RSD" href="../../xmlrpc.php?rsd">
	<meta name="generator" content="WordPress 6.4.1">
	<meta name="generator" content="WooCommerce 8.2.1">
	<link rel="canonical" href="index.htm">
	<link rel='shortlink' href='index.htm?p=1015'>
	<link rel="alternate" type="application/json+oembed" href="../../wp-json/oembed/1.0/embed-76?url=https%3A%2F%2Fdemo.ovatheme.com%2Faovis%2Fmovie%2Fthe-witcher%2F">
	<link rel="alternate" type="text/xml+oembed" href="../../wp-json/oembed/1.0/embed-77?url=https%3A%2F%2Fdemo.ovatheme.com%2Faovis%2Fmovie%2Fthe-witcher%2F&#038;format=xml">
	<noscript>
		<style>
...
<body class="movie-template-default single single-movie postid-1015 wp-embed-responsive theme-aovis woocommerce-no-js group-blog has-post-thumbnail layout_2r woo_layout_1c elementor-default elementor-kit-6">
											...
											<nav class="container-menu dir_left">
												...
												<!-- <div class="primary-navigation">
													<ul id="menu-primary-menu-1" class="menu">
														<li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home menu-item-has-children menu-item-56"><a href="../../index.htm">Home</a>
														</li>
														<li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-2311"><a href="../../events/index.htm">Thể Loại</a>
															<ul class="sub-menu">
																<li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-3418"><a href="../../events/index.htm">Event Grid</a></li>
																<li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-3426"><a href="../../event-list/index.htm">Event List</a></li>
																<li class="menu-item menu-item-type-post_type menu-item-object-event menu-item-3339"><a href="../../event/the-strange-love-movie-oscar-event/index.htm">Event Details</a></li>
															</ul>
														</li>

														<li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-2311"><a href="../../events/index.htm">Quốc Gia</a>
															<ul class="sub-menu">
																<li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-3418"><a href="../../events/index.htm">Event Grid</a></li>
																<li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-3426"><a href="../../event-list/index.htm">Event List</a></li>
																<li class="menu-item menu-item-type-post_type menu-item-object-event menu-item-3339"><a href="../../event/the-strange-love-movie-oscar-event/index.htm">Event Details</a></li>
														...
														<li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-2311"><a href="../../events/index.htm">Nhà Sản</a>
															<ul class="sub-menu">
																<li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-3418"><a href="../../events/index.htm">Event Grid</a></li>
																<li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-3426"><a href="../../event-list/index.htm">Event List</a></li>
																<li class="menu-item menu-item-type-post_type menu-item-object-event menu-item-3339"><a href="../../event/the-strange-love-movie-oscar-event/index.htm">Event Details</a></li>
												...
												<div class="header_breadcrumbs">
													<!-- <div id="breadcrumbs">
														<ul class="breadcrumb">
															...
															<li><a href="../../categories/categories.php?TheLoai='<?php echo $row["TheLoai"] ?>'"><?php echo $row["TheLoai"] ?></a> <span class="separator"><i class="ovaicon-next"></i></span> </li>
															<li><?php echo $row["TenPhim"] ?></li>
														</ul>
													</div> -->
												</div>

												<h1 class=" header_title">
													<?php echo $row["TenPhim"] ?> </h1>
											</div>
					...
					<div class="ova_movie_single">
							...
							<div class="movie-heading">
								...
								<div class="categories-and-time">
									<div class="movie-category">
										<a href="../../categories/categories.php?TheLoai='<?php echo $row["TheLoai"] ?>'" title="Action"><?php echo $row["TheLoai"] ?></a>
									</div>
						...
						<div class="movie-media has-trailer">
							...
							<div class="movie-gallery">
								<a class="gallery-fancybox" data-src="../../img/<?php echo $row["AnhChinh"] ?>" data-fancybox="movie-gallery-fancybox">
									<img src="../../img/<?php echo $row["AnhChinh"] ?>" alt="<?php echo $row["AnhChinh"] ?>" title="Movie Gallery">
								</a>
							</div>
...
<div class="mb-movie-cast-list four_column">

	                <div class="movie-cast-item">
            <div class="cast-thumbnail">
                <img src="../../wp-content/uploads/2023/02/cast-01.jpg" alt="Millie Brown">
            </div>
            <div class="cast-info">
                <h4 class="cast-name">Millie Brown</h4>
                <p class="cast-description">
                    ...
                    <div class="movie-cast-item">
            <div class="cast-thumbnail">
                <img src="../../wp-content/uploads/2023/02/cast-02.jpg" alt="Finn Wolfhard">
            </div>
            <div class="cast-info">
                <h4 class="cast-name">Finn Wolfhard</h4>
                <p class="cast-description">
                    as Mike Wheeler                </p>
            </div>
        </div>
                    <div class="movie-cast-item">
            <div class="cast-thumbnail">
                <img src="../../wp-content/uploads/2023/02/cast-03.jpg" alt="Winona Ryder">
            </div>
            <div class="cast-info">
                <h4 class="cast-name">Winona Ryder</h4>
                <p class="cast-description">
                    as Joyce Byers                </p>
            </div>
        </div>
                    <div class="movie-cast-item">
            <div class="cast-thumbnail">
                <img src="../../wp-content/uploads/2023/02/cast-04.jpg" alt="David Harbour">
            </div>
            <div class="cast-info">
                <h4 class="cast-name">David Harbour</h4>
                <p class="cast-description">
                    as Jim Hopper                </p>
            </div>
        </div>
                    <div class="movie-cast-item">
            <div class="cast-thumbnail">
                <img src="../../wp-content/uploads/2023/02/cast-05.jpg" alt="Gaten Matarazo">
            </div>
            <div class="cast-info">
                <h4 class="cast-name">Gaten Matarazo</h4>
                <p class="cast-description">
                    as Ted Wheeler                </p>
            </div>
        </div>
                    <div class="movie-cast-item">
            <div class="cast-thumbnail">
                <img src="../../wp-content/uploads/2023/02/cast-06.jpg" alt="Natalia Dyer">
            </div>
            <div class="cast-info">
                <h4 class="cast-name">Natalia Dyer</h4>
                <p class="cast-description">
                    as Nancy Wheeler                </p>
            </div>
        </div>
                    <div class="movie-cast-item">
            <div class="cast-thumbnail">
                <img src="../../wp-content/uploads/2023/02/cast-07.jpg" alt="Caleb Laughlin">
            </div>
            <div class="cast-info">
                <h4 class="cast-name">Caleb Laughlin</h4>
                <p class="cast-description">
                    as Lucas Sinclair                </p>
            </div>
        </div>
                    <div class="movie-cast-item">
            <div class="cast-thumbnail">
                <img src="../../wp-content/uploads/2023/02/cast-08.jpg" alt="Sadie Sink">
            </div>
            <div class="cast-info">
                <h4 class="cast-name">Sadie Sink</h4>
                <p class="cast-description">
                    as Max Mayfield                </p>
            </div>
        </div>
							...
							$(document).ready(function() {
								$('.feedback-btn').click(function(e) {
									...
									$.ajax({
										...
										$('.xuly-feedback').html(ketqua)
									})
								})
							})
						</script>
						<div class="container__feedback">
							<div class="container_feedback__content" style="padding-top:12px;">
								<form class="content" style="color:white; font-size:23px;">Comment:
									<input type=text style="width:60%" class="comment">
									<input type=hidden value=<?php echo $row["IDPhim"] ?> class="idphim">
									<input type=hidden value=<?php echo $IDKhachHang ?> class="idkhachhang">
									<input type=button class="feedback-btn" value="Comment">
								</form>
							</div>
							<div class="xuly-feedback">
						...
						<div class="movie-related">
							...
							<div class="mb-movie-list mb-movie-list-template1 four_column">
								<?php
								$result = $conn->query("$sql");
								$row = $result->fetch_assoc();
								$TheLoai = $row["TheLoai"];
								//$TheLoai = $_GET("TheLoai");
								$sql2 = "select * from phim where TheLoai= '" . $TheLoai . "' and IDPhim !=" . $IDPhim;
								$result = $conn->query("$sql2");
								while ($row = $result->fetch_assoc()) {
								?>
									<div class="mb-movie-item item-template1">

										<a href="../detail/detail.php?IDPhim=<?php echo $row["IDPhim"] ?>&TheLoai='<?php echo $row["TheLoai"] ?>'" title="Alis Keep Walking">
											<div class="movie-image">
												<img src="../../img/<?php echo $row["AnhChinh"] ?>" alt="Alis Keep Walking">
											</div>
										</a>
		...
		<div class="brand_el">
			...
			<div class="elementor-widget-wrap elementor-element-populated">
				...
				<div class="elementor-widget-container">
			<style>
.elementor-widget-text-editor.elementor-drop-cap-view-stacked .elementor-drop-cap{background-color:#69727d;color:#fff}.elementor-widget-text-editor.elementor-drop-cap-view-framed .elementor-drop-cap{color:#69727d;border:3px solid;background-color:transparent}.elementor-widget-text-editor:not(.elementor-drop-cap-view-default) .elementor-drop-cap{margin-top:8px}.elementor-widget-text-editor:not(.elementor-drop-cap-view-default) .elementor-drop-cap-letter{width:1em;height:1em}.elementor-widget-text-editor .elementor-drop-cap{float:left;text-align:center;line-height:1;font-size:50px}.elementor-widget-text-editor .elementor-drop-cap-letter{display:inline-block}</style>				<a href="../../about/index.htm">Help</a> / <a href="../../privacy-policy/index.htm">Privacy Policy</a>						</div>
				</div>
...
.elementor-widget-social-icons.elementor-grid-0 .elementor-widget-container,.elementor-widget-social-icons.elementor-grid-mobile-0 .elementor-widget-container,.elementor-widget-social-icons.elementor-grid-tablet-0 .elementor-widget-container{line-height:1;font-size:0}.elementor-widget-social-icons:not(.elementor-grid-0):not(.elementor-grid-tablet-0):not(.elementor-grid-mobile-0) .elementor-grid{display:inline-grid}.elementor-widget-social-icons .elementor-grid{grid-column-gap:var(--grid-column-gap,5px);grid-row-gap:var(--grid-row-gap,5px);grid-template-columns:var(--grid-template-columns);justify-content:var(--justify-content,center);justify-items:var(--justify-content,center)}.elementor-icon.elementor-social-icon{font-size:var(--icon-size,25px);line-height:var(--icon-size,25px);width:calc(var(--icon-size, 25px) + (2 * var(--icon-padding, .5em)));height:calc(var(--icon-size, 25px) + (2 * var(--icon-padding, .5em)))}.elementor-social-icon{--e-social-icon-icon-color:#fff;display:inline-flex;background-color:#69727d;align-items:center;justify-content:center;text-align:center;cursor:pointer}.elementor-social-icon i{color:var(--e-social-icon-icon-color)}.elementor-social-icon svg{fill:var(--e-social-icon-icon-color)}.elementor-social-icon:last-child{margin:0}.elementor-social-icon:hover{opacity:.9;color:#fff}.elementor-social-icon-android{background-color:#a4c639}.elementor-social-icon-apple{background-color:#999}.elementor-social-icon-behance{background-color:#1769ff}.elementor-social-icon-bitbucket{background-color:#205081}.elementor-social-icon-codepen{background-color:#000}.elementor-social-icon-delicious{background-color:#39f}.elementor-social-icon-deviantart{background-color:#05cc47}.elementor-social-icon-digg{background-color:#005be2}.elementor-social-icon-dribbble{background-color:#ea4c89}.elementor-social-icon-elementor{background-color:#d30c5c}.elementor-social-icon-envelope{background-color:#ea4335}.elementor-social-icon-facebook,.elementor-social-icon-facebook-f{background-color:#3b5998}.elementor-social-icon-flickr{background-color:#0063dc}.elementor-social-icon-foursquare{background-color:#2d5be3}.elementor-social-icon-free-code-camp,.elementor-social-icon-freecodecamp{background-color:#006400}.elementor-social-icon-github{background-color:#333}.elementor-social-icon-gitlab{background-color:#e24329}.elementor-social-icon-globe{background-color:#69727d}.elementor-social-icon-google-plus,.elementor-social-icon-google-plus-g{background-color:#dd4b39}.elementor-social-icon-houzz{background-color:#7ac142}.elementor-social-icon-instagram{background-color:#262626}.elementor-social-icon-jsfiddle{background-color:#487aa2}.elementor-social-icon-link{background-color:#818a91}.elementor-social-icon-linkedin,.elementor-social-icon-linkedin-in{background-color:#0077b5}.elementor-social-icon-medium{background-color:#00ab6b}.elementor-social-icon-meetup{background-color:#ec1c40}.elementor-social-icon-mixcloud{background-color:#273a4b}.elementor-social-icon-odnoklassniki{background-color:#f4731c}.elementor-social-icon-pinterest{background-color:#bd081c}.elementor-social-icon-product-hunt{background-color:#da552f}.elementor-social-icon-reddit{background-color:#ff4500}.elementor-social-icon-rss{background-color:#f26522}.elementor-social-icon-shopping-cart{background-color:#4caf50}.elementor-social-icon-skype{background-color:#00aff0}.elementor-social-icon-slideshare{background-color:#0077b5}.elementor-social-icon-snapchat{background-color:#fffc00}.elementor-social-icon-soundcloud{background-color:#f80}.elementor-social-icon-spotify{background-color:#2ebd59}.elementor-social-icon-stack-overflow{background-color:#fe7a15}.elementor-social-icon-steam{background-color:#00adee}.elementor-social-icon-stumbleupon{background-color:#eb4924}.elementor-social-icon-telegram{background-color:#2ca5e0}.elementor-social-icon-thumb-tack{background-color:#1aa1d8}.elementor-social-icon-tripadvisor{background-color:#589442}.elementor-social-icon-tumblr{background-color:#35465c}.elementor-social-icon-twitch{background-color:#6441a5}.elementor-social-icon-twitter{background-color:#1da1f2}.elementor-social-icon-viber{background-color:#665cac}.elementor-social-icon-vimeo{background-color:#1ab7ea}.elementor-social-icon-vk{background-color:#45668e}.elementor-social-icon-weibo{background-color:#dd2430}.elementor-social-icon-weixin{background-color:#31a918}.elementor-social-icon-whatsapp{background-color:#25d366}.elementor-social-icon-wordpress{background-color:#21759b}.elementor-social-icon-xing{background-color:#026466}.elementor-social-icon-yelp{background-color:#af0606}.elementor-social-icon-youtube{background-color:#cd201f}.elementor-social-icon-500px{background-color:#0099e5}.elementor-shape-rounded .elementor-icon.elementor-social-icon{border-radius:10%}.elementor-shape-circle .elementor-icon.elementor-social-icon{border-radius:50%}</style>		<div class="elementor-social-icons-wrapper elementor-grid">
		...
		<div class="ova-heading ova-heading-template1">
			...
			<div class="top-heading has-square-corner">
				...
				<ul id="menu-footer-menu-movies" class="menu"><li id="menu-item-3203" class="menu-item menu-item-type-taxonomy menu-item-object-movie_cat current-movie-ancestor current-menu-parent current-movie-parent menu-item-3203"><a href="../../movie_cat/action/index.htm">Action</a></li>
<li id="menu-item-3204" class="menu-item menu-item-type-taxonomy menu-item-object-movie_cat menu-item-3204"><a href="../../movie_cat/adventure/index.htm">Adventure</a></li>
<li id="menu-item-3205" class="menu-item menu-item-type-taxonomy menu-item-object-movie_cat menu-item-3205"><a href="../../movie_cat/animation/index.htm">Animation</a></li>
<li id="menu-item-3206" class="menu-item menu-item-type-taxonomy menu-item-object-movie_cat menu-item-3206"><a href="../../movie_cat/comedy/index.htm">Comedy</a></li>
<li id="menu-item-3207" class="menu-item menu-item-type-taxonomy menu-item-object-movie_cat menu-item-3207"><a href="../../movie_cat/crime/index.htm">Crime</a></li>
</ul>			</div>
				</div>
				</div>
					</div>
		...
		<div class="ova-heading ova-heading-template1">
			...
			<div class="top-heading has-square-corner">
				...
				<div class="elementor-widget-container">
						<div class="ova-menu-footer">
				<ul id="menu-footer-menu-links" class="menu"><li id="menu-item-3208" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-3208"><a href="../../about/index.htm">About</a></li>
<li id="menu-item-3209" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-3209"><a href="../../my-account/index.htm">My account</a></li>
<li id="menu-item-3210" class="menu-item menu-item-type-post_type menu-item-object-page current_page_parent menu-item-3210"><a href="../../news/index.htm">News</a></li>
<li id="menu-item-3629" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-3629"><a href="../../events/index.htm">Latest Events</a></li>
<li id="menu-item-3211" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-3211"><a href="../../contact/index.htm">Contact</a></li>
</ul>			</div>
				</div>
				</div>
					</div>
...
</script><form id="mc4wp-form-1" class="mc4wp-form mc4wp-form-184" method="post" data-id="184" data-name="Footer"><div class="mc4wp-form-fields"><div class="ova-subscribe-form-wrapper ">
    ...
    <label>
        <input name="_mc4wp_lists[]" type="checkbox" value="Ovatheme" checked="true"> <span>Ovatheme</span>
...
</div><label style="display: none !important;">Leave this field empty if you're human: <input type="text" name="_mc4wp_honeypot" value="" tabindex="-1" autocomplete="off"></label><input type="hidden" name="_mc4wp_timestamp" value="1699953914"><input type="hidden" name="_mc4wp_form_id" value="184"><input type="hidden" name="_mc4wp_form_element_id" value="mc4wp-form-1"><div class="mc4wp-response"></div></form></div>
				</div>
				</div>
					</div>
		</div>
			...
			<div class="elementor-widget-wrap elementor-element-populated">
				...
				<div class="elementor-widget-container">
							© Copyright 2023 by Ovatheme.com						</div>
				</div>
					</div>
		</div>
							</div>
		...
		<style id='elementor-frontend-inline-css' type='text/css'>
			...
			<?php
			$sql_bg = "select * from phim where IDPhim = $IDPhim";
			$resultbg = $conn->query("$sql_bg");
			$row = $resultbg->fetch_assoc()
			?>.elementor-108 .elementor-element.elementor-element-4c25947>.elementor-background-overlay {
				background-image: url("../../img/<?php echo $row["AnhThem"]; ?>");
		...
		<script type="text/javascript" src="../../wp-content/plugins/movie-booking/assets/libs/fancybox/fancybox.umd.js?ver=6.4.1" id="fancybox-js"></script>
		...
		<script type="text/javascript" id="elementor-frontend-js-before">
			...
			var elementorFrontendConfig = {
				...
				"post": {
					"id": 1015,
					"title": "The%20Witcher%20Season%202%20%E2%80%93%20Aovis%20%E2%80%93%20Film%20%26%20Movie%20Booking%20WordPress%20Theme",
					"excerpt": "Writen and Directed by Aleesha Rose \/ Ireland 2023",
					"featuredImage": "https:\/\/demo.ovatheme.com\/aovis\/wp-content\/uploads\/2023\/02\/movie-image-02.jpg"
				}
			};
			/* ]]> */
		</script>
