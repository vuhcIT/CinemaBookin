...
<body style="background-color:#d96c2c;" ng-app="liveBookingApp" ng-controller="liveBookingController">
    <div class="booking-panel">
        ...
        <div class="booking-panel-section booking-panel-section2" onclick="window.location.href='../movie/detail/detail.php?IDPhim=<?php echo $IDPhim; ?>'; return false;">
    <i class="fas fa-2x fa-times"></i>
        ...
        <div class="booking-panel-section booking-panel-section4">
            ...
            <div class="booking-form-container">
                ...
                <form id="bookingForm" action="../../vnpay_php/vnpay_php/vnpay_pay.php" method="post">
                    <input type=hidden name="txtIdPhim" value=<?php echo $row["IDPhim"] ?> id="idphim">
                    <input type=hidden name="txtIdKhachHang" value=<?php echo $IDKhachHang ?> id="idkhachhang">
                    <input type="hidden" name="txtGiaVe" value=<?php echo $row["GiaVe"]?> id="idgiave">
                    <input type="hidden" name="txtTenPhim" value=<?php echo $row["TenPhim"]?> id="idtenphim">

                    <select id="NgayChieuSelect" name="txtNgayChieu">
                        <option>Date</option>
                        <?php
                        $sql_date = "select  DISTINCT DATE(buoichieu.BuoiChieu) AS NgayChieu ,buoichieu.IDBuoiChieu from buoichieu where buoichieu.BuoiChieu>NOW() and buoichieu.IDPhim=" . $IDPhim . "
                                        GROUP by NgayChieu";
                    ...
                    <button class="btn btn-success" style="background-color: #28a745;">Thanh Toán Online</button>
                </form>
